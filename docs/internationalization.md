...
- Verified business-profile facts can have approved locale variants. Missing variants fall back to the verified base value without an automatic AI translation.
